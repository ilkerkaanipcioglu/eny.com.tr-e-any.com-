export const translations = {
  tr: {
    ...
    heroCtaSecondary: 'Projenizi Konuşalım',
    heroStat: '100+',
    ...
    // -- Contact Page --
    contactTitle: 'Doğru Mimariyi Birlikte Kuralım',
    contactDesc: 'Finansal dönüşüm hedeflerinizi doğrudan çözüm mimarlarımızla görüşün. SAP ve AI destekli altyapı stratejinizi bugün planlayalım.',
  ...
  en: {
    ...
    heroCtaSecondary: 'Let\'s Talk Project',
    heroStat: '100+',
    ...
    contactTitle: 'Let\'s Build the Right Architecture',
    contactDesc: 'Consult directly with our solution architects to discuss your financial transformation goals. Plan your SAP and AI-powered infrastructure strategy today.',
