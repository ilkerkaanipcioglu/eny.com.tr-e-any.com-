export const translations = {
  tr: {
    ...
    contactSubtitle: 'Finansal mimarinizi modernize etmek ve AI destekli SAP altyapı hedeflerinize ulaşmak için doğrudan çözüm mimarlarımızla görüşün.',
    formName: 'Ad Soyad',
    ...
    footerSvcCbc: 'Sınır Tanımaz Ticaret',
    ...
    techDesc: 'Bulut bilişim, yapay zeka ve düşük kodlu platformlar ile operasyonel sınırlarınızı ortadan kaldırıyoruz. Modern SAP ekosistemiyle tanışın.',
  ...
  en: {
    ...
    contactSubtitle: 'Consult directly with our solution architects to modernize your financial architecture and achieve your AI-powered SAP goals.',
    formName: 'Full Name',
    ...
    footerSvcCbc: 'Cross-Border Commerce',
    ...
    techDesc: 'We eliminate your operational boundaries with cloud computing, AI, and low-code platforms. Meet the modern SAP ecosystem.',
